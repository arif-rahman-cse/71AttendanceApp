...
import com.ekattorit.ekattorattendance.ui.home.model.Employee;
...
public class EmployeeListAdapter extends RecyclerView.Adapter<EmployeeListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (position % 4 == 0){
            holder.binding.ivOutletGo.setImageResource(R.drawable.ic_verified_user);
        }else {
            holder.binding.ivOutletGo.setImageResource(R.drawable.ic_warning);
        }
